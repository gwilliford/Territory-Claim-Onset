setwd("C:/Users/gwill/Dropbox/Research/Dissertation/chapter4/manuscript")
library(readr)
library(dplyr)
library(tvcure)
library(compiler)
...
i0_curenew = tvcure(Surv(start, stop, fail) ~ pchcaprat + bdymid + systchange + ww1 + ww2 + coldwar,
...
i0_curenewts = tvcure(Surv(start, stop, fail) ~ pchcap + bdymid +
